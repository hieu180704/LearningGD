...
$pages = @(
    ...
    @{ name = "lesson-tang-3-04-progression-phan-thuong"; file = "lessons/tang-3/04-progression-phan-thuong.html"; heightOverride = @{ desktop = 20000; mobile = 32000 } },
    @{ name = "lesson-tang-3-05-level-design"; file = "lessons/tang-3/05-level-design.html"; heightOverride = @{ desktop = 20000; mobile = 32000 } },
    @{ name = "lesson-tang-3-06-ux-onboarding"; file = "lessons/tang-3/06-ux-onboarding.html"; heightOverride = @{ desktop = 20000; mobile = 32000 } },
    @{ name = "lesson-tang-3-07-narrative-design"; file = "lessons/tang-3/07-narrative-design.html"; heightOverride = @{ desktop = 20000; mobile = 32000 } },
    ...
    @{ name = "lesson-tang-4-03-dao-duc-dark-patterns"; file = "lessons/tang-4/03-dao-duc-dark-patterns.html"; heightOverride = @{ desktop = 20000; mobile = 32000 } },
    @{ name = "lesson-tang-4-04-mo-xe-game"; file = "lessons/tang-4/04-mo-xe-game.html"; heightOverride = @{ desktop = 20000; mobile = 32000 } },
    @{ name = "lesson-tang-4-05-portfolio-con-duong"; file = "lessons/tang-4/05-portfolio-con-duong.html"; heightOverride = @{ desktop = 20000; mobile = 32000 } },
    @{ name = "lesson-capstone-01-thiet-ke-game-nho"; file = "lessons/capstone/01-thiet-ke-game-nho.html"; heightOverride = @{ desktop = 20000; mobile = 32000 } }
)
$viewports = @(
